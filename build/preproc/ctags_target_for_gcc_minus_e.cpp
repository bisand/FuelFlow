# 1 "c:\\Users\\andre.biseth\\Documents\\Arduino\\BatteryMonitor\\BatteryMonitor.ino"
# 1 "c:\\Users\\andre.biseth\\Documents\\Arduino\\BatteryMonitor\\BatteryMonitor.ino"
...
# 12 "c:\\Users\\andre.biseth\\Documents\\Arduino\\BatteryMonitor\\BatteryMonitor.ino" 2
...
# 19 "c:\\Users\\andre.biseth\\Documents\\Arduino\\BatteryMonitor\\BatteryMonitor.ino" 2
# 20 "c:\\Users\\andre.biseth\\Documents\\Arduino\\BatteryMonitor\\BatteryMonitor.ino" 2
...
//      these details outside of recompiling the program.
const char BatteryMonitorManufacturerInformation [] = "André Biseth, andre@biseth.net";
const char BatteryMonitorInstallationDescription1 [] = "Fuel Flow Monitor";
const char BatteryMonitorInstallationDescription2 [] = "Monitoring fuel flow for diesel engine with return fuel line.";
...
void __attribute__((section(".iram1" "." "11"))) handleInterrupt() //This is the function that the interupt calls 
{
...
//  NMEA2000.SetN2kCANMsgBufSize(2);                    // For this simple example, limit buffer size to 2, since we are only sending data
  ...
  pinMode(interruptPin, 0x05); //initializes digital pin 2 as an input
  attachInterrupt((((interruptPin)<40)?(interruptPin):-1), handleInterrupt, 0x02); //and the interrupt is attached
}
...
void loop() {
  if (millis() - previousMillis > interval) {
    ...
    Serial.print (pulses, 10); //Prints the number calculated above
    Serial.println (" pulses"); //Prints "L/hour" and returns a  new line
    Serial.print (calc, 10); //Prints the number calculated above
